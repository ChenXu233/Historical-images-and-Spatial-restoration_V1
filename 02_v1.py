...
def estimate_camera_orientation(points_data, focal_lengths, sensor_sizes, image_size):
    ...
    for focal_length in focal_lengths:
        for (sensor_width, sensor_height) in sensor_sizes:
            ...
            # 计算重投影误差
            errors_initial = compute_reprojection_error(pos3d, pixels, K, dist_coeffs, initial_rotation_vector,
            ...
            optimized_rotation_vector, optimized_translation_vector = cv2.solvePnPRefineLM(
                pos3d, pixels, K, dist_coeffs, initial_rotation_vector, initial_translation_vector
            )

            errors_optimized = compute_reprojection_error(pos3d, pixels, K, dist_coeffs, optimized_rotation_vector,
            ...
            all_results.append((distance_to_known_origin, symbols, mean_error_initial, mean_error_optimized, K,
                                focal_length, sensor_width, sensor_height, camera_origin))
